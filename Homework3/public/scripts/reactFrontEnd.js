...
var PeopleMain = React.createClass({
  ...
  render: function() {
    return (
      ...
      <Form onPeopleSubmit={this.handlePeopleSubmit} />
      </div>
    );
  }
});
...
var Form = React.createClass({
  ...
  handleSubmit: function(e) {
    ...
    this.props.onPeopleSubmit({firstName: firstName, lastName: lastName, hireDate: hireDate});
    this.setState({firstName: '', lastName: '', hireDate: ''});
  },
  render: function() {
    return (
